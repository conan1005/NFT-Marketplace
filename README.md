...
![Home Page](https://github.com/geetikajhanji11/NFT-marketplace/blob/master/images/home_page.png)
...
- Configure Metamask Settings
    ...
    Currency Symbol: ETH
    ```
    ![settings](https://github.com/geetikajhanji11/NFT-marketplace/blob/master/images/metamask_settings.png)
...
- Login to Metamask and import some hardhat accounts to Metamask by using Private Keys
    ![hardhatnode](https://github.com/geetikajhanji11/NFT-marketplace/blob/master/images/hardhat_node.png)

    ![hardhatnode](https://github.com/geetikajhanji11/NFT-marketplace/blob/master/images/import.png)
